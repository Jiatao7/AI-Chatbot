...
class TicTacToe:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path='tictactoe_game/resources/field.png', res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path='tictactoe_game/resources/o.png', res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path='tictactoe_game/resources/x.png', res=[CELL_SIZE] * 2)
