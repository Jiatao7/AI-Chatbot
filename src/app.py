...
from actual_chess import ChessGame
...
class ChatApp:
    ...
    def home_screen(self):
        ...
        placeholder_button_3 = tk.Button(self.root, text="Chess", state=tk.DISABLED, font=("Arial", 16, "bold"), bg="#555555", fg="white", width=20, height=2)
